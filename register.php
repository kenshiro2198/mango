...
<body>
    <div class="wrapper"><a class="btn btn-outline-primary backbtn" role="button" href="./index.php"><i class="material-icons">arrow_back</i></a>
        <form method="post" id="registerform" class="log-reg-container">
            ...
            <div class="form-group"><input class="form-control log-reg-input" type="text" name="username" placeholder="ID Number" id="username"></div>
            ...
            <div class="form-group"><input class="form-control log-reg-input" type="password" name="password" placeholder="Confirm Password" id="confpassword"></div>
            <div class="form-group button"><button class="btn btn-primary btn-block form-button" type="submit" id="verifybtn">Log In</button></div>
        </form>
    </div>
