...
?>
            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody id="department_detail">
                        <?php
                        $departmentsql = "SELECT * FROM deparment WHERE schoolyear_id = '$sysession' AND delete_flag = 0";
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="form-group"><input class="form-control addschoolyear-input stoptypedept" id="department" name="department" type="text"><span class="badge badge-primary logerrmsg errmsgcontainer"><?php echo $department; ?> is already existing</span></div>
