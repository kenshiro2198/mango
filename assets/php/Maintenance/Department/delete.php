...
?>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="form-group"><input class="form-control addschoolyear-input stoptypedept" id="department" name="department" type="text"><span class="badge badge-primary success-badge">Successfully Deleted!</span></div>
