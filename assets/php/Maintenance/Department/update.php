...
?>
            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody id="department_detail">
                        <?php
                        $departmentsql = "SELECT * FROM department WHERE schoolyear_id = '$sysession'";
                        $departmentres = mysqli_query($conn,$departmentsql);
                        $departmentsqlcount = "SELECT COUNT(*) as activecount FROM department WHERE schoolyear_id = '$sysession'";
                        $departmentrescount = mysqli_query($conn,$departmentsqlcount);
                        $departmentfetcount = mysqli_fetch_assoc($departmentrescount);
                        for ($a=0; $a < $departmentfetcount["activecount"]; $a++) { 
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="form-group"><input class="form-control addschoolyear-input stoptypedept" id="department" name="department" type="text"><span class="badge badge-primary success-badge"><?php echo $Previous_Department." to ".$department; ?></span></div>
